...
export async function initializeStorageBucket(bucketName: string, isPublic = true) {
  try {
...
export async function deleteFilesFromBucket(bucketName: string, filePaths: string[]) {
  try {
