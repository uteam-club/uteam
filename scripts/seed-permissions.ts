...
const permissions = [
  ...
  { code: 'gps.reports.read', description: 'GPS отчеты (просмотр)' },
  { code: 'gps.reports.create', description: 'GPS отчеты (создание)' },
  { code: 'gps.reports.update', description: 'GPS отчеты (редактирование)' },
  { code: 'gps.reports.delete', description: 'GPS отчеты (удаление)' },
  { code: 'gps.reports.export', description: 'GPS отчеты (экспорт)' },
  { code: 'gps.profiles.read', description: 'GPS профили (просмотр)' },
  { code: 'gps.profiles.create', description: 'GPS профили (создание)' },
  { code: 'gps.profiles.update', description: 'GPS профили (редактирование)' },
  { code: 'gps.profiles.delete', description: 'GPS профили (удаление)' },
  { code: 'gps.data.edit', description: 'GPS данные (редактирование)' },
...
const rolePermissions: Record<string, string[]> = {
  ...
  COACH: [
    ...
    'gps.profiles.read', 'gps.profiles.create', 'gps.profiles.update', 'gps.profiles.delete',
    'gps.reports.read', 'gps.reports.create', 'gps.reports.update', 'gps.reports.delete', 'gps.reports.export',
    'gps.data.edit',
  ],
  MEMBER: [
    'teams.read',
