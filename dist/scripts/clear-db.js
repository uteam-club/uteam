...
import { user, player, team, club, event as eventTable, exercise, exerciseCategory, exerciseTag, match, mediaItem, morningSurveyResponse, muscleArea, painArea, playerAttendance, playerDocument, playerMatchStat, schedule, scheduleEvent, survey, surveySchedule, teamCoach, training, trainingExercise, exerciseTagToExercise } from '../src/db/schema';
