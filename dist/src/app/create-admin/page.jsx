...
function CreateAdminForm() {
    ...
    return (<div className="min-h-screen bg-vista-dark flex flex-col py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="card">
          <form className="space-y-6" onSubmit={handleSubmit}>
            {error && (<div className="p-3 mb-3 text-sm text-white bg-vista-error rounded">
                {error}
              </div>)}
            
            {success && (<div className="p-3 mb-3 text-sm text-white bg-vista-success rounded">
                {success}
              </div>)}
            ...
            <div className="form-group">
              ...
              <input id="clubName" name="clubName" type="text" value={formData.clubName} onChange={handleChange} className="form-input" required/>
            </div>
            ...
            <div className="form-group">
              ...
              <input id="clubSubdomain" name="clubSubdomain" type="text" value={formData.clubSubdomain} onChange={handleChange} className="form-input" required/>
            </div>
            ...
            <div className="form-group">
              ...
              <input id="secret" name="secret" type="password" value={formData.secret} onChange={handleChange} className="form-input" required/>
            </div>

            <div>
              <button type="submit" disabled={isLoading} className="w-full btn-primary flex justify-center items-center">
...
export default function CreateAdminPage() {
    return (<Suspense fallback={<div className="min-h-screen bg-vista-dark flex flex-col justify-center items-center">
