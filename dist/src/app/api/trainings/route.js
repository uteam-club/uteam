...
export async function GET(request) {
    try {
        ...
        const formatted = rows.map(row => {
            ...
            const dateOnly = dateObj === null || dateObj === void 0 ? void 0 : dateObj.toISOString().split('T')[0];
            const timeOnly = dateObj === null || dateObj === void 0 ? void 0 : dateObj.toISOString().split('T')[1].slice(0, 5);
            return {
                id: row.id,
                title: row.title,
                teamId: row.teamId,
                team: row.teamName,
                date: (_a = row.date) === null || _a === void 0 ? void 0 : _a.toISOString(),
                dateOnly,
                time: timeOnly,
...
export async function POST(request) {
    ...
    try {
        const token = await getTokenFromRequest(request);
        debug = Object.assign(Object.assign({}, debug), { token });
        if (!token) {
        ...
        debug = Object.assign(Object.assign({}, debug), { incomingData: data });
        ...
        debug = Object.assign(Object.assign({}, debug), { trainingData });
        ...
        const formattedTraining = {
            ...
            team: (teamRow === null || teamRow === void 0 ? void 0 : teamRow.name) || '',
            date: created.date.toISOString(), // полная дата-время
            dateOnly,
            time: timeOnly,
            categoryId: created.categoryId,
            category: (catRow === null || catRow === void 0 ? void 0 : catRow.name) || '',
...
async function fetchTeamName(teamIdValue) {
    var _a;
    try {
        const teamRow = await db.select({ name: team.name }).from(team).where(eq(team.id, teamIdValue));
        return ((_a = teamRow[0]) === null || _a === void 0 ? void 0 : _a.name) || 'Неизвестная команда';
    }
    catch (error) {
...
async function fetchCategoryName(categoryIdValue) {
    var _a;
    try {
        ...
        return ((_a = catRow[0]) === null || _a === void 0 ? void 0 : _a.name) || 'Неизвестная категория';
    }
    catch (error) {
...
export async function PUT(request) {
    ...
    try {
        ...
        const formattedTraining = {
            ...
            team: (teamRow === null || teamRow === void 0 ? void 0 : teamRow.name) || '',
            date: (_a = updated.date) === null || _a === void 0 ? void 0 : _a.toISOString(),
            dateOnly,
            time: timeOnly,
