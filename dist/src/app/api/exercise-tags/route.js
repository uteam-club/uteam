...
export async function GET(req) {
    ...
    try {
        ...
        console.log('Данные сессии:', {
            ...
            clubId: (_b = session === null || session === void 0 ? void 0 : session.user) === null || _b === void 0 ? void 0 : _b.clubId
        });
        ...
        const tagsWithCategoryObj = exerciseTags.map(tag => (Object.assign(Object.assign({}, tag), { exerciseCategory: tag.exerciseCategoryName ? { name: tag.exerciseCategoryName } : undefined })));
        // Возвращаем список тегов
        return new NextResponse(JSON.stringify(tagsWithCategoryObj), {
            status: 200,
            headers: {
                'Content-Type': 'application/json',
            }
...
export async function POST(req) {
    ...
    try {
        ...
        console.log('Данные сессии:', {
            ...
            userId: (_a = session === null || session === void 0 ? void 0 : session.user) === null || _a === void 0 ? void 0 : _a.id,
            clubId: (_b = session === null || session === void 0 ? void 0 : session.user) === null || _b === void 0 ? void 0 : _b.clubId,
            role: (_c = session === null || session === void 0 ? void 0 : session.user) === null || _c === void 0 ? void 0 : _c.role
        });
        ...
        return NextResponse.json(Object.assign(Object.assign({}, tagWithCategory), { exerciseCategory: tagWithCategory.exerciseCategoryName ? { name: tagWithCategory.exerciseCategoryName } : undefined }));
    }
    catch (error) {
        console.error('Ошибка при создании тега упражнений:', error);
        return NextResponse.json({ error: 'Ошибка при создании тега упражнений' }, { status: 500 });
    }
}
