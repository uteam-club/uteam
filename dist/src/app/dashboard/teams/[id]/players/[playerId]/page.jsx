...
import { ChevronLeftIcon, SaveIcon, UserIcon, FileTextIcon } from 'lucide-react';
...
export default function PlayerProfilePage() {
        ...
        async function fetchPlayerData() {
            ...
            try {
                ...
                setFormData({
                    ...
                    number: ((_a = data.player.number) === null || _a === void 0 ? void 0 : _a.toString()) || '',
    ...
    const handleImageChange = (imageUrl) => {
        setFormData(prev => (Object.assign(Object.assign({}, prev), { imageUrl: imageUrl || '' })));
    };
    ...
    if (error) {
        return (<Card className="bg-vista-dark/50 border-vista-secondary/30">
        <CardContent className="p-6">
          <div className="text-center py-8">
            ...
            <Button className="mt-4 bg-vista-primary hover:bg-vista-primary/90 text-vista-dark" onClick={handleBackToTeam}>
              Вернуться к команде
            </Button>
          </div>
        </CardContent>
    ...
    return (<div className="space-y-6">
      ...
      <div className="flex items-center space-x-4">
        <Button variant="outline" size="sm" onClick={handleBackToTeam} className="border-vista-secondary/30 text-vista-light hover:bg-vista-secondary/20">
      ...
      <form onSubmit={handleSubmit}>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card className="bg-vista-dark/50 border-vista-secondary/30">
            ...
            <CardContent>
              <ImageUpload value={formData.imageUrl} onChange={handleImageChange} disabled={isSaving} avatarMode={true} clubId={(_a = session === null || session === void 0 ? void 0 : session.user) === null || _a === void 0 ? void 0 : _a.clubId} teamId={teamId} entityId={playerId} entityType="player"/>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="lastName" name="lastName" value={formData.lastName} onChange={handleInputChange} className="bg-vista-dark/70 border-vista-secondary/30 text-vista-light" placeholder="Введите фамилию" disabled={isSaving}/>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input id="firstName" name="firstName" value={formData.firstName} onChange={handleInputChange} className="bg-vista-dark/70 border-vista-secondary/30 text-vista-light" placeholder="Введите имя" disabled={isSaving}/>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input id="middleName" name="middleName" value={formData.middleName} onChange={handleInputChange} className="bg-vista-dark/70 border-vista-secondary/30 text-vista-light" placeholder="Введите отчество" disabled={isSaving}/>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input id="number" name="number" type="number" value={formData.number} onChange={handleInputChange} className="bg-vista-dark/70 border-vista-secondary/30 text-vista-light" placeholder="Укажите номер" disabled={isSaving} min={1} max={99}/>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Select value={formData.position} onValueChange={(value) => handleSelectChange('position', value)} disabled={isSaving}>
                ...
                <div className="space-y-2">
                  ...
                  <Select value={formData.strongFoot} onValueChange={(value) => handleSelectChange('strongFoot', value)} disabled={isSaving}>
                    <SelectTrigger className="bg-vista-dark/70 border-vista-secondary/30 text-vista-light">
                ...
                <div className="space-y-2">
                  ...
                  <CountrySelect value={formData.nationality} onChange={(value) => handleSelectChange('nationality', value)} disabled={isSaving}/>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input id="dateOfBirth" name="dateOfBirth" type="date" value={formData.dateOfBirth} onChange={handleInputChange} className="bg-vista-dark/70 border-vista-secondary/30 text-vista-light" disabled={isSaving}/>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input id="academyJoinDate" name="academyJoinDate" type="date" value={formData.academyJoinDate} onChange={handleInputChange} className="bg-vista-dark/70 border-vista-secondary/30 text-vista-light" disabled={isSaving}/>
                </div>
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  <TeamSelect teams={teams} value={formData.teamId} onChange={(value) => handleSelectChange('teamId', value)} disabled={isSaving}/>
                </div>
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  <Input id="pinCode" value={player.pinCode} className="bg-vista-dark/70 border-vista-secondary/30 text-vista-light" disabled={true} readOnly/>
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  <Input id="telegramId" value={player.telegramId || ''} className="bg-vista-dark/70 border-vista-secondary/30 text-vista-light" disabled={true} readOnly/>
                  <p className="text-xs text-vista-light/70 mt-1">
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  <Input id="birthCertificateNumber" name="birthCertificateNumber" value={formData.birthCertificateNumber} onChange={handleInputChange} className="bg-vista-dark/70 border-vista-secondary/30 text-vista-light" placeholder="Введите номер свидетельства о рождении" disabled={isSaving}/>
                </div>
              </div>

              {error && (<div className="mt-4 p-3 bg-red-500/10 border border-red-500/30 rounded-md text-red-500 text-sm">
                  {error}
                </div>)}

              <div className="mt-6 flex justify-end">
                <Button type="submit" disabled={isSaving} className="bg-vista-primary hover:bg-vista-primary/90 text-vista-dark">
                  {isSaving ? (<>
          ...
          <Card className="bg-vista-dark/50 border-vista-secondary/30 md:col-span-3">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {/* Паспорт */}
                <DocumentUpload onUpload={(file) => handleDocumentUpload(file, 'PASSPORT')} onDelete={((_b = documents.find(doc => doc.type === 'PASSPORT')) === null || _b === void 0 ? void 0 : _b.id)
            ? () => handleDocumentDelete(documents.find(doc => doc.type === 'PASSPORT').id)
            : undefined} documentType="Паспорт" documentName={(_c = documents.find(doc => doc.type === 'PASSPORT')) === null || _c === void 0 ? void 0 : _c.name} documentId={(_d = documents.find(doc => doc.type === 'PASSPORT')) === null || _d === void 0 ? void 0 : _d.id} isUploaded={documents.some(doc => doc.type === 'PASSPORT')} disabled={isSaving || isLoadingDocuments}/>
                
                {/* Свидетельство о рождении */}
                <DocumentUpload onUpload={(file) => handleDocumentUpload(file, 'BIRTH_CERTIFICATE')} onDelete={((_e = documents.find(doc => doc.type === 'BIRTH_CERTIFICATE')) === null || _e === void 0 ? void 0 : _e.id)
            ? () => handleDocumentDelete(documents.find(doc => doc.type === 'BIRTH_CERTIFICATE').id)
            : undefined} documentType="Свидетельство о рождении" documentName={(_f = documents.find(doc => doc.type === 'BIRTH_CERTIFICATE')) === null || _f === void 0 ? void 0 : _f.name} documentId={(_g = documents.find(doc => doc.type === 'BIRTH_CERTIFICATE')) === null || _g === void 0 ? void 0 : _g.id} isUploaded={documents.some(doc => doc.type === 'BIRTH_CERTIFICATE')} disabled={isSaving || isLoadingDocuments}/>
                
                {/* Медицинская страховка */}
                <DocumentUpload onUpload={(file) => handleDocumentUpload(file, 'MEDICAL_INSURANCE')} onDelete={((_h = documents.find(doc => doc.type === 'MEDICAL_INSURANCE')) === null || _h === void 0 ? void 0 : _h.id)
            ? () => handleDocumentDelete(documents.find(doc => doc.type === 'MEDICAL_INSURANCE').id)
            : undefined} documentType="Медицинская страховка" documentName={(_j = documents.find(doc => doc.type === 'MEDICAL_INSURANCE')) === null || _j === void 0 ? void 0 : _j.name} documentId={(_k = documents.find(doc => doc.type === 'MEDICAL_INSURANCE')) === null || _k === void 0 ? void 0 : _k.id} isUploaded={documents.some(doc => doc.type === 'MEDICAL_INSURANCE')} disabled={isSaving || isLoadingDocuments}/>
              </div>
