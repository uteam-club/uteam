      ...
      <div className="z-10 max-w-2xl w-full">
        ...
        <form action="/api/clubs" method="POST" className="space-y-6">
          <div>
            ...
            <input type="text" id="name" name="name" required className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Название клуба"/>
          </div>
          ...
          <div>
            ...
            <div className="flex">
              <input type="text" id="subdomain" name="subdomain" required className="w-full px-4 py-2 border rounded-l-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="club-name"/>
          ...
          <div>
            ...
            <input type="url" id="logoUrl" name="logoUrl" className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="https://example.com/logo.png"/>
            <p className="text-sm text-gray-500 mt-1">
