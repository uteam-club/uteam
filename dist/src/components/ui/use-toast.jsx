...
export const reducer = (state, action) => {
    switch (action.type) {
        ...
        case "DISMISS_TOAST": {
            ...
            // Если toastId не определен, закрываем все уведомления
            if (toastId === undefined) {
                state.toasts.forEach((toast) => {
                    addToRemoveQueue(toast.id);
                });
                return Object.assign(Object.assign({}, state), { toasts: state.toasts.map((t) => (Object.assign(Object.assign({}, t), { open: false }))) });
            }
            // Закрываем конкретное уведомление
            addToRemoveQueue(toastId);
            return Object.assign(Object.assign({}, state), { toasts: state.toasts.map((t) => t.id === toastId
