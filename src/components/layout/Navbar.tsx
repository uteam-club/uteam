    ...
    <nav className="bg-vista-dark border-b-[2px] border-vista-secondary">
      <div className="container-app h-16 flex items-center justify-between" ref={dropdownRef}>
                  ...
                  {item.hasDropdown ? (
                    <div className="relative h-full flex items-center">
                      ...
                      {isDropdownActive(item.key) && (
                        <div className="absolute z-[9999] top-full mt-1 w-48 rounded-md shadow-lg bg-vista-dark/50 backdrop-blur-md border-2 border-vista-secondary/40">
                          <div className="py-1">
        ...
        <div className="relative ml-2 h-full flex items-center">
          ...
          {langMenuOpen && (
            <div className="absolute right-0 top-full mt-1 w-40 bg-vista-dark/50 backdrop-blur-md rounded-md shadow-lg z-[9999] py-1 border-2 border-vista-secondary/40">
              <Link
