    ...
    <DialogContent className="bg-vista-dark/95 border border-vista-secondary/30 text-vista-light shadow-xl rounded-xl max-w-md w-full overflow-hidden backdrop-blur-xl">
      ...
      <div className="space-y-4 py-2">
        <div className="space-y-2">
          ...
          <Input id="training-category-name" name="name" value={newCategory.name} onChange={onChange} className="bg-vista-dark/70 border-vista-secondary/30 text-vista-light" placeholder="Введите название" disabled={loading} />
        </div>
      </div>
