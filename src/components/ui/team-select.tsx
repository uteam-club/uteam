    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <button
          ...
          aria-expanded={open}
          className={cn(
            "flex h-10 w-full items-center justify-between rounded-md border border-vista-secondary/30 bg-vista-dark px-3 py-2 text-sm text-vista-light ring-offset-vista-dark placeholder:text-vista-light/70 focus:outline-none focus:ring-2 focus:ring-vista-primary/70 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50",
            className
          )}
          disabled={disabled}
        >
