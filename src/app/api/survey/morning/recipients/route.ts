...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    if (!teamId || typeof isIndividualMode !== 'boolean') {
      console.log('Validation failed:', { teamId, isIndividualMode, selectedPlayerIds });
    ...
    console.log('Recipients config to save:', recipientsConfig);
    ...
    return NextResponse.json({ 
      message: 'Настройки получателей сохранены!', 
      result,
      recipientsConfig 
    });
